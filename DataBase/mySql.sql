...
INSERT INTO Promocoes (preco_promo, validade) VALUES
(1200.00, '2023-05-10'),
(1400.00, '2023-06-05'),
(1500.00, '2023-07-15'),
(1300.00, '2023-08-01'),
...
INSERT INTO Reserva (cliente_id, promocao_id, destino_id, valor, data_ida, data_return) VALUES
...
-- Compra - Cliente
SELECT r.id_reserva, c.nome AS nome_cliente, d.pais AS destino, p.preco_promo AS preco_promocao, r.dataIda, r.dataRetorno
FROM Reserva AS r
...
FROM Destinos AS d
JOIN Reserva AS r ON d.id_destino = r.destino_id
JOIN Promocoes AS p ON r.promocao_id = p.id_promocao
ORDER BY destino;
...
-- Reserva
UPDATE Reserva SET dataIda = '2023-12-25', dataRetorno = '2023-12-31' WHERE id_reserva = 6;
