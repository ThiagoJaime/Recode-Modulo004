    ...
    <section id="pack"
        ...
        <div class="container">
            <div class="gallary-header text-center">
                ...
                <p>Ofertas personalizadas e únicas, criadas para atender às necessidades exclusivas dos clientes.</p>
            </div>
            <div class="packages-content">
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="single-package-item">
                            <img src="assets/IMGs/packages/p1.jpg"
                                 alt="package-place">
                            <div class="single-package-item-txt">
                                <h3>Itália <span class="float-end">$750</span></h3>
                                <div class="packages-para">
                                    <p><span><i class="fa fa-angle-right"></i> 5 Dias - 6 Noites</span><i
                                           class="fa fa-angle-right"></i> 5 Estrelas</p>
                                    <p><span><i class="fa fa-angle-right"></i> Transportes</span><i
                                           class="fa fa-angle-right"></i> instalações de alimentação</p>
                                </div>
                                <div class="packages-review">
                                    <p><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                           class="fa fa-star"></i><i class="fa fa-star"></i><span>2544 Avaliações</span>
                                    </p>
                                </div>
                                <div class="about-btn">
                                    <a href="login.html">
                                        <button class="btn about-view packages-btn">
                                            Viaje Agora
                                        </button>
                                    </a>
                                </div>
